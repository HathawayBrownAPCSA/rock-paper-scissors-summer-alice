...
/**
 * Class RPSMatch2 plays a game of Rock, Paper, Scissors but allows the human to win every time by cheating
 *
 * @author Summer Mu
 * @version 10.24.2022
 */
public class RPSMatch2
{
    ...
    /**
     * This method gets the string for computerPlay based on what the human chooses to play
     * @param nothing
     * @return "Rock", "Paper", or "Scissors" such that the computer will always lose
     */
